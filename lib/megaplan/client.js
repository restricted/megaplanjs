...
var clientProto = {
    ...
    /**
     * Returns tags as a list of objects.
     *
     * Список меток как список объектов.
     *
     * [More info]{@link https://help.megaplan.ru/API_tags_list}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     */
    tags: function (o) {
        o = o || {};
        return this.__request('::tags/list.api', utils.objectFilter(o));
    },
     ...
     * Создает метку.
     *
     * [More info]{@link https://help.megaplan.ru/API_tags_create}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     */
    tag_create: function (o) {
        o = o || {};
        return this.__request('::tags/Create.api', utils.objectFilter(o));
    },
     ...
     * Обновляет метку.
     *
     * [More info]{@link https://help.megaplan.ru/API_tags_update}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     */
    tag_update: function (o) {
        return this.__request('::tags/update.api', utils.objectFilter(o));
    },
     ...
     * Удаление метки.
     *
     * [More info]{@link https://help.megaplan.ru/API_tags_delete}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     */
    tag_delete: function (o) {
        return this.__request('::tags/delete.api', utils.objectFilter(o));
    },
     ...
     * Назначение метки.
     *
     * [More info]{@link https://help.megaplan.ru/API_tags_assign}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     */
    tag_assign: function (o) {
        return this.__request('::tags/assign.api', utils.objectFilter(o));
    },
     ...
     * Поиск по меткам.
     *
     * [More info]{@link https://help.megaplan.ru/API_tags_search}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     */
    tags_search: function (o) {
        return this.__request('::tags/search.api', utils.objectFilter(o));
    },
     ...
     * @returns {MegaplanRequest}
     */
    contractors: function (filter_id, search, limit, offset, model, phone) {
        var o = filter_id;
        (o instanceof Object) || (o = {
            filter_id: filter_id,
            qs: search,
    ...
    /**
     * Get list of phone types (client).
     *
     * Список типов номеров (для клиентов).
     *
     * [More info]{@link https://dev.megaplan.ru/api/API_data.html#api-phone-types-list}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите
     * официальную документацию для получения большей информации.
     * @returns {MegaplanRequest}
     */
    phoneTypes: function (o) {
        return this.__request(':staff/Employee/phoneTypes.api', utils.objectFilter(o));
    },
    ...
    /**
     * Get list of deal`s fields.
     *
     * Получает список доступных полей сделки.
     *
     * [More info]{@link https://dev.megaplan.ru/r1702/api/API_deals.html#api-deal-available-fields-list}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите
     * официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     *
     */
    deal_list_fields: function (o) {
        return this.__request('::deal/listFields.api', utils.objectFilter(o));
    },

    /**
     * Get deal comments.
     *
     * Получить список комментариев к сделке.
     *
     * [More info]{@link https://help.megaplan.ru/API_comment_list}
     *
     * @param {Number} subject_id Deal ID
     * @returns {MegaplanRequest}
     *
     */
    deal_comments: function (deal_id) {
        return this.__request('::comment/list.api', {subject_type: 'deal', subject_id: deal_id});
    },
     ...
     *
     * [More info]{@link https://dev.megaplan.ru/api/API_comments.html#id5}
     *
     * @param {Number} comment_id Comment ID
     * @returns {MegaplanRequest}
     */
    comment: function (comment_id) {
        return this.__request('::comment/commentById.api', {id: comment_id});
    },
     ...
     * Написание комментария к сделке.
     *
     * [More info]{@link https://dev.megaplan.ru/api/API_comments.html#id10}
     *
     * @param {Number} deal_id Deal ID. ID сделки
     * @param {String} text Content. Текст комментария
     * @param {String} [hours] Time spend to a task. Время, потраченное на клиента
     ...
     *
     * [More info]{@link https://dev.megaplan.ru/api/API_invoices.html}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите
     * официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     ...
     */
    offers: function (o) {
        return this.__request('::offer/list.api', utils.objectFilter(o));
    },
     ...
     */
    invoices: function (o) {
        return this.__request('::invoice/list.api', utils.objectFilter(o));
    },

    /**
     *
     * Получить список схем сделок
     *
     * [More info]{@link https://dev.megaplan.ru/api/API_deals.html#id12}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите
     * официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     ...
     */
    programs: function (o) {
        return this.__request('::program/list.api', utils.objectFilter(o));
    },

    /**
     *
     * Авторизация приложения в Мегаплан
     *
     * [More info]{@link https://dev.megaplan.ru/apps/index.html#id9}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите
     * официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
     *
     */
    check_user_sign: function (o) {
        return this.__request('::application/checkUserSign.api?uuid=' + o.uuid + '&userSign=' + o.userSign);
    },

    /**
     *
     * Создать событие Мегаплан
     *
     * [More info]{@link https://dev.megaplan.ru/api/API_events.html#id10}
     *
     * @param {Object} o parameters of request. More info in official documentation. Параметры запроса. Смотрите
     * официальную документацию для получения большей информации
     * @returns {MegaplanRequest}
